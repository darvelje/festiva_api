...
// section Routes_Business_Coupons
    Route::get('/v1/business/coupons/all', [\App\Http\Controllers\v1\BusinessController::class, 'getBusinesses']);
    Route::get('/v1/business/coupons/view/{businessSlug}', [\App\Http\Controllers\v1\BusinessController::class, 'getBusinessBySlug']);
    Route::post('/v1/business/coupons/new', [\App\Http\Controllers\v1\BusinessController::class, 'newBusiness']);
    Route::post('/v1/business/coupons/update', [\App\Http\Controllers\v1\BusinessController::class, 'updateBusiness']);
    Route::delete('/v1/business/coupons/delete', [\App\Http\Controllers\v1\BusinessController::class, 'deleteBusiness']);
